...
export class pgSelectFXComponent implements OnInit, AfterContentInit, AfterContentChecked, ControlValueAccessor {
  ...
  onTouched: () => void = () => null;
  @ViewChild('searchInput', { read: true, static: false }) searchInputElementRef;
  @ViewChild('trigger', { read: true, static: false }) trigger: ElementRef;
  @ViewChild('dropdownUl', { read: true, static: false }) dropdownUl: ElementRef;
  @ViewChild('csOptions', { read: true, static: false }) csOptions: ElementRef;
  @ViewChild('placeHolder', { read: true, static: false }) placeHolder: ElementRef;
  @Output() SearchChange: EventEmitter<string> = new EventEmitter();
  @Output() OpenChange: EventEmitter<boolean> = new EventEmitter();
  @Output() ScrollToBottom: EventEmitter<boolean> = new EventEmitter();
  @Input() Filter = true;
  @Input() MaxMultiple = Infinity;
  @ViewChild(CdkConnectedOverlay, { read: true, static: false }) _cdkOverlay: CdkConnectedOverlay;
