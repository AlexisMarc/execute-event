...
export class pgTimePickerInnerComponent implements OnInit, ControlValueAccessor {
  ...
  @ViewChild('hourListInstance', { read: true, static: false }) _hourListInstance;
  @ViewChild('minuteListInstance', { read: true, static: false }) _minuteListInstance;
  @ViewChild('inputTimeInstance', { read: true, static: false }) _inputTimeInstance;
  @ViewChild('secondListInstance', { read: true, static: false }) _secondListInstance;
