...
export class ChatComponent implements OnInit {
  ...
  onSubmit() {
    ...
    //Se cambia por este el sendMessage2
    this.sendMessage.sendMessage(formData, this.keysession, this.residential_id);
    this.message = '';
    this.profileForm.reset();
  }

// Este metodo se utiliza para que funcione la tarjeta de envio de mensaje en el chat
//   sendMessage2(dataMessage, keysession, residential_id) {
...
//         var bsAlert = new bootstrap.Toast(myAlert, { delay: 3000 });
//         bsAlert.show();
//       }
