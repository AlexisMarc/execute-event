    ...
    path: 'home', component: CondensedComponent, children: [
      {
        path: '', component: DashboardComponent, children: [
          ...
          //esta version se comenta parala version sin chat SIN-CHAT
          { path: 'chat', component: ChatComponent },
          // FIN esta version se comenta parala version sin chat
          { path: 'ayuda', component: UserHelpComponent },
          //esta version se comenta parala version sin chat SIN-PARTICIPANTES
          { path: 'participantes', component: MenuParticipantsComponent},
          // FIN esta version se comenta parala version sin participantes
        ]
      },
    ]
  },
