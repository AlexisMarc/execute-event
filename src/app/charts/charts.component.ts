...
export class ChartsComponent implements OnInit,OnDestroy {
  ...
  @ViewChild('pieChartContainer', { read: true, static: false }) _pieChartContainer: ElementRef;
  echartsIntance;
  
  @ViewChild('realTimeChartWrapper', { read: true, static: false }) _realTimeChartWrapper: ElementRef;
  realtimeChartInitOptions;
  realtimeChartOptions;
  realtimeChartIntance;
  realtimeChartUpdate;

  @ViewChild('areaSliderChartWrapper', { read: true, static: false }) _areaSliderChartWrapper: ElementRef;
