...
import { CondensedDashboardComponent } from "./condensed/dashboard.component";
import { CasualDashboardComponent } from "./casual/dashboard.component";
import { SimplyWhiteDashboardComponent } from "./simplywhite/dashboard.component";
...
@NgModule({
  imports: [pgCardModule, pgTabsModule, pgSwitchModule],
